package com.liferay.workflow.docusign.constants;

public final class DocuSignMailerConstants {
    public static final String CONFIG_FOLDER_IDENTIFIER_DEFAULT = "0";
    ...
    public static final String CONFIG_USE_WORKFLOW_CONTEXT_KEY_FOR_DOCUMENT_DEFAULT = "false";
    public static final String CONFIG_DOCUMENT_WORKFLOW_CONTEXT_KEY_DEFAULT = "";
    public static final String CONFIG_DOCUMENT_DEFAULT = "contract.pdf";
    public static final String CONFIG_DOCUMENT_LOOKUP_TYPE_DEFAULT = "filename";
    public static final String CONFIG_EMAIL_SUBJECT_TEMPLATE_DEFAULT = "DocuSign Example";
    public static final String CONFIG_EMAIL_BODY_TEMPLATE_DEFAULT = "This is a test email";
}
